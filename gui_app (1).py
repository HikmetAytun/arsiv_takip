...
class YeniDosyaDialog(QDialog):
    def __init__(self, kullanici: dict):
        ...
        self.notlar      = QTextEdit(); self.notlar.setFixedHeight(70)
        ...
        # Teslim alan — kullanıcı dropdown + serbest yazım
        ...
        ada_lbl = QLabel("Ada"); ada_lbl.setStyleSheet(f"font-size:11px;color:{P['txt4']};")
        pars_lbl = QLabel("Parsel"); pars_lbl.setStyleSheet(f"font-size:11px;color:{P['txt4']};")
        ada_row.addWidget(ada_lbl); ada_row.addWidget(self.ada, stretch=1)
        ada_row.addWidget(pars_lbl); ada_row.addWidget(self.parsel, stretch=1)
    ...
    def kaydet(self):
        try:
            ...
            if not t: raise ValueError("Teslim alan personel seçin veya yazın.")
